...
async def predict_p1(request: Request):
    return RedirectResponse(url='./static/POSTP1.html')
...
@app.post('/POSTP1',response_class=HTMLResponse)
async def testGET(request: Request,       
    ...
    'CTRL_A': CTRL_A,
    'CTRL_B': CTRL_B,
    'TOTAL_STR_A_x': TOTAL_STR_A_x,
    'TOTAL_STR_A_y': TOTAL_STR_A_y,
    'TOTAL_STR_B_x': TOTAL_STR_B_x,
    'TOTAL_STR_B_y': TOTAL_STR_B_y,
    'TD_A_x': TD_A_x,
    'TD_A_y': TD_A_y,
    'TD_B_x': TD_B_x,
    'TD_B_y': TD_B_y,
    'STR_HEAD_A_x': STR_HEAD_A_x,
    'STR_HEAD_A_y': STR_HEAD_A_y,
    'STR_HEAD_B_x': STR_HEAD_B_x,
    'STR_HEAD_B_y': STR_HEAD_B_y,
    'STR_BODY_A_x': STR_BODY_A_x,
    'STR_BODY_A_y': STR_BODY_A_y,
    'STR_BODY_B_x': STR_BODY_B_x,
    'STR_BODY_B_y': STR_BODY_B_y,
    'STR_LEG_A_x': STR_LEG_A_x,
    'STR_LEG_A_y': STR_LEG_A_y,
    'STR_LEG_B_x': STR_LEG_B_x,
    'STR_LEG_B_y': STR_LEG_B_y,
    'STR_DISTANCE_A_x': STR_DISTANCE_A_x,
    'STR_DISTANCE_A_y': STR_DISTANCE_A_y,
    'STR_DISTANCE_B_x': STR_DISTANCE_B_x,
    'STR_DISTANCE_B_y': STR_DISTANCE_B_y,
    'STR_CLINCH_A_x': STR_CLINCH_A_x,
    'STR_CLINCH_A_y': STR_CLINCH_A_y,
    'STR_CLINCH_B_x': STR_CLINCH_B_x,
    'STR_CLINCH_B_y': STR_CLINCH_B_y,
    'STR_GROUND_A_x': STR_GROUND_A_x,
    'STR_GROUND_A_y': STR_GROUND_A_y,
    'STR_GROUND_B_x': STR_GROUND_B_x,
    'STR_GROUND_B_y': STR_GROUND_B_y,
    'KD_DIFF': KD_DIFF,
    'SIG_STR_DIFF': SIG_STR_DIFF,
    'TD_DIFF': TD_DIFF,
    'SUB_ATT_DIFF': SUB_ATT_DIFF,
    'REV_DIFF': REV_DIFF,
    'CTRL_DIFF': CTRL_DIFF,
    'STRIKER_A': STRIKER_A,
    'STRIKER_B': STRIKER_B,
    'GRAPPLER_A': GRAPPLER_A,
    'GRAPPLER_B': GRAPPLER_B,
    'Record_A': Record_A,
    'Record_B': Record_B,
    'Peleas_A': Peleas_A,
    'Peleas_B': Peleas_B,
    ...
    'Racha_A': Racha_A,
    'Racha_B': Racha_B,
    'Victorias_KO_A': Victorias_KO_A,
    'Victorias_KO_B': Victorias_KO_B,
    'Victorias_Sub_A': Victorias_Sub_A,
    'Victorias_Sub_B': Victorias_Sub_B,
    'Victorias_Decision_A': Victorias_Decision_A,
    'Victorias_Decision_B': Victorias_Decision_B,
    'Derrotas_KO_A': Derrotas_KO_A,
    'Derrotas_KO_B': Derrotas_KO_B,
    'Derrotas_Sub_A': Derrotas_Sub_A,
    'Derrotas_Sub_B': Derrotas_Sub_B,
    'Derrotas_Decision_A': Derrotas_Decision_A,
    'Derrotas_Decision_B': Derrotas_Decision_B
    }
    pelea = pd.DataFrame([pelea_dict])
    # pelea = PeleaP1(**pelea_dict)
